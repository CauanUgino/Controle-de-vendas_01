...
def CadastroProduto():
    """Esta função é respnsável por reunir as informações necessárias para cadastrar um novo produto"""
    print("CADASTRO DE NOVO PRODUTO!")
    nome = input("Digite o nome do produto: ").strip()
    preco = float(input("Digite o preço: "))
    qtd = int(input("Digite a quantidade: "))
    validade_obj = datetime.strptime(input("Digite a validade (dd/mm/aaaa): "), "%d/%m/%Y").date()
